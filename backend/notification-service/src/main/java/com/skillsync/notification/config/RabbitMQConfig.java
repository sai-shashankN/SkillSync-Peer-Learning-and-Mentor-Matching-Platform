...
public class RabbitMQConfig {
    ...
    public Queue notificationQueue() {
        return QueueBuilder.durable(RabbitMQConstants.NOTIFICATION_QUEUE)
                ...
                .deadLetterRoutingKey(RabbitMQConstants.NOTIFICATION_DLQ)
                .build();
    }
    ...
    @Bean
    public Binding notificationBinding(Queue notificationQueue, TopicExchange skillsyncEventsExchange) {
